...
$url = "http://localhost/test/playlist.json"; //ローカル用
...
<body>
    ...
    <script>
        ...
        if (json_array_size == 0) {
            ...
            Ajax(1, "http://localhost/test/parameter_directory_copy.php"); //ローカル用
        ...
        function $on(event, selector) {
            ...
            $(document).on(event, selector, function(el) {
                ...
                Ajax(data, "http://localhost/test/test2_html_save.php");//ローカル用
