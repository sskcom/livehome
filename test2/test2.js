...
window.onload = function() {
    ...
    function buttonAdd() {
        ...
        Ajax(key, "http://localhost/test/parameter_directory_copy.php"); //ローカル用
...
$(document).on('click', ".button3", function(el) {
    ...
    Ajax(number - 1, "http://localhost/test/parameter_directory_delete.php"); //ローカル用
...
$(document).on('click', ".button2", function(el) {
    ...
    location.href = "http://localhost/test/all_parameter/parameter_" + number + "/parameter.php"; //ローカル用
...
$(document).on('click', "#btn2", function() {
    ...
    for (var i = 0; i < song_number; i++) {
        ...
        Ajax(1, "http://localhost/test/all_parameter/parameter_" + song_number_id[i] + "/json_csv_conv_1.php"); //ローカル用
        // Ajax(1, "http://54.248.37.203/test/all_parameter/parameter_" + song_number_id[i] + "/json_csv_conv_2.php");
        Ajax(1, "http://localhost/test/all_parameter/parameter_" + song_number_id[i] + "/json_csv_conv_2.php"); //ローカル用
        // Ajax(1, "http://54.248.37.203/test/all_parameter/parameter_" + song_number_id[i] + "/json_csv_conv_3.php");
        Ajax(1, "http://localhost/test/all_parameter/parameter_" + song_number_id[i] + "/json_csv_conv_3.php"); //ローカル用
        // Ajax(1, "http://54.248.37.203/test/all_parameter/parameter_" + song_number_id[i] + "/json_csv_conv_4.php");
        Ajax(1, "http://localhost/test/all_parameter/parameter_" + song_number_id[i] + "/json_csv_conv_4.php"); //ローカル用
    }
    ...
    Ajax("1," + song_number, "http://localhost/test/play_trigger_write.php"); //ローカル用

    // Ajax(song_number, "http://54.248.37.203/test/playlist_div_extract.php");
    Ajax(song_number, "http://localhost/test/playlist_div_extract.php"); //ローカル用　
});